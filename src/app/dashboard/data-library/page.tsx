...
export default async function DataLibraryPage() {
  ...
  const initialWorkspace =
    initialWorkspaces[0]
      ? await getWorkspaceDetail(initialWorkspaces[0].id, userId).catch(() => null)
      : null
  ...
  return (
    <>
      <SiteHeader
        title="Data Library"
        description="Manage your canonical library and the workspace-specific knowledge attached to each research environment."
      />
